...
class ConsensusAgent(Agent):
    ...
    def __init__(
        self, unique_id: int, model, initial_value: float, protocol: AbstractProtocol
    ):
        super().__init__(model)
        self.unique_id = unique_id
        self.state = AgentState(agent_id=unique_id, value=initial_value, neighbors=[])
    ...
    def step(self):
        ...
        self.next_value = self.protocol.calculate_next_value(
